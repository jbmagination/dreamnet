 ...
 */
!function(a){var b={width:14,height:14,clippy_path:"clippy.swf",keep_text:!1,force_load:!1,flashvars:{},swfobject_attributes:{}};a.fn.clippy=function(c){c=a.extend(!0,b,c);var d=!1;try{var e=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");e&&(d=!0)}catch(f){void 0!=navigator.mimeTypes["application/x-shockwave-flash"]&&(d=!0)}d||c.force_load?a.each(a(this),function(b,d){var e="";e="undefined"!=typeof c.text?c.text:a(d).data("text")&&""!=a.trim(a(d).data("text"))?a(d).data("text"):a.trim(a(d).text()),e=encodeURIComponent(e);var f="";if("undefined"==typeof a(d).attr("id")||""===a.trim(a(d).attr("id"))){var g=Math.round(10240*Math.random()).toString(16);f="clippy-"+g,a(d).attr("id",f)}else f=a(d).attr("id");c.keep_text||a(d).html("");var h=a.extend({},c.flashvars,{text:e});swfobject.embedSWF(c.clippy_path,f,c.width,c.height,"10",!1,h,{scale:"noscale"},c.swfobject_attributes)}):a.each(this,function(b,c){a(c).css({display:"none"})})}}(jQuery);